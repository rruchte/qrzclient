...
* There is a quirk of the QRX XML Schema that sends the city in an element called "addr2". For clarity, we have chosen to rename that field to "city" on output.
